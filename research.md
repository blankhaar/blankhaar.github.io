...
My research is built around a simple idea: the detailed physics of molecules — how they rotate, vibrate, polarize, and emit light — can reveal how the largest structures in the Universe form and evolve. A molecule in a planet-forming disk, in the wind of an evolved star, in a dust grain drifting through a diffuse cloud, even in the Earth's atmosphere, is — to a sufficiently careful theory — a precision instrument. My work builds and uses those instruments.

In practice that gets you a broader portfolio than it might sound. Much of my work circles cosmic magnetism — how magnetic fields organise the formation of stars and planets, how they thread the gas flows in and out of the most extreme galactic nuclei, how the very smallest dust grains polarize the radiation they emit — but the same physical toolkit takes me into corners of physics and chemistry that look much further afield. The fundamental quantum theory of how light propagates through a dense gas of molecules. The chirality of organic molecules in interstellar space. The thread is not the subject matter; it is the conviction that, with enough precision, exotic physics and chemistry can be bent into a tool.

Despite the breadth, the methodological backbone is narrow: polarized radiative transfer of molecular and atomic spectral lines, paired with the molecular and atomic physics that decides what those lines actually look like. Two open-source codes I wrote and use, [PORTAL and CHAMP]({{ '/code/' | relative_url }}), are the working tools.
