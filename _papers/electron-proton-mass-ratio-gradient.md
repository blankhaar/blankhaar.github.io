---
title: Probing the electron-to-proton mass ratio gradient in the Milky Way with Class I methanol masers
slug: electron-proton-mass-ratio-gradient
authors: S. A. Levshakov, I. I. Agafonova, C. Henkel, K.-T. Kim, M. G. Kozlov, B. Lankhaar, W. Yang
...
arxiv: "2112.14560"
ads: https://ui.adsabs.harvard.edu/abs/2022MNRAS.511..413L
summary: A subtle test of fundamental physics — does the electron-to-proton mass ratio change across the Galaxy? — using methanol masers as exquisitely sensitive frequency standards.
---
...
Some theories beyond the Standard Model predict that the values of fundamental dimensionless constants — like the electron-to-proton mass ratio μ = m<sub>e</sub> / m<sub>p</sub> — are not the same everywhere, but vary subtly with environment, with depth in a gravitational potential, or simply with location in the Universe. A spatial gradient of μ across the Milky Way would show up as a systematic frequency shift in any line whose frequency depends sensitively on μ.
